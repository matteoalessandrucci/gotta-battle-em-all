...
class PkmBattleUX(arcade.Window):
    ...
    def setup(self):
        ...
        self.background = arcade.load_texture("gotta-battle-em-all/ux/sprites/background.png")
    ...
    def _init_game(self, data):
        ...
        type0_0 = data[0]
        n = 1
        self.party[0].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type0_0}_{n}.png", SPRITE_SCALING))
        ...
        self.party[0].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type0_1}_{n}.png", SPRITE_SCALING))
        ...
        self.party[0].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type0_2}_{n}.png", SPRITE_SCALING))
        ...
        type1_0 = data[8]
        n = 1
        self.party[1].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type1_0}_{n}.png", SPRITE_SCALING))
        ...
        self.party[1].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type1_1}_{n}.png", SPRITE_SCALING))
        ...
        self.party[1].append(arcade.Sprite(f"gotta-battle-em-all/ux/sprites/pkm/{type1_2}_{n}.png", SPRITE_SCALING))
    ...
    def _attack(self, data):
        ...
        move = data[1]
        dmg = data[2]
        self.attack = arcade.Sprite(f"gotta-battle-em-all/ux/sprites/move/{move}.png", SPRITE_SCALING)
